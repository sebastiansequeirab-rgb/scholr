...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const prompt = `Eres un extractor preciso de horarios académicos. Hoy es ${todayStr}. Año académico en curso: ${currentYear}. Analiza la imagen y extrae CADA bloque horario visible.
